...
class SimpleFeedForwardEstimator(PyTorchEstimator):
    ...
    def __init__(
        ...
        self.num_hidden_dimensions = num_hidden_dimensions if num_hidden_dimensions is not None else list([40, 40])
        ...
        self.train_sampler = ExpectedNumInstanceSampler(num_instances=1, min_future=prediction_length)
